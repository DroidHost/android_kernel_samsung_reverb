...
void Sda_rev_check(void)
{
	if (system_rev <= 2)
		GPIO_TOUCHKEY_SDA = 83;
	else
		GPIO_TOUCHKEY_SDA = 80;
}
...
static void cypress_power_onoff(int onoff)
{
	...
	/*printk(KERN_ERR "cypress_power_onoff");*/
}
