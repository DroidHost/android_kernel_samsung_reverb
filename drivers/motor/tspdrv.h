 ...
 * */
u_int32_t g_nlra_gp_clk_PreDiv;
u_int32_t g_nlra_gp_clk_m;
u_int32_t g_nlra_gp_clk_n;
u_int32_t g_nlra_gp_clk_d;
u_int32_t g_nlra_gp_clk_pwm_mul;
