...
#if defined(CONFIG_SENSORS_TAOS) || defined(CONFIG_OPTICAL_GP2A)
...
#if defined(CONFIG_SENSORS_TAOS) || defined(CONFIG_OPTICAL_GP2A)
	rc = pm8xxx_gpio_config(ps_vout.gpio, &ps_vout);
	if (rc) {
...
static const unsigned int vital2refresh_keymap[] = {
	KEY(0, 0, KEY_POWER),
	KEY(0, 1, KEY_Q),
	KEY(0, 2, KEY_A),
	KEY(0, 3, KEY_F1),
	...
	KEY(6, 0, KEY_HOMEPAGE),
	KEY(6, 1, KEY_U),
	KEY(6, 2, KEY_J),
	KEY(6, 3, KEY_N),
	KEY(6, 4, KEY_SEARCH),

	KEY(7, 0, KEY_CAMERA_SNAPSHOT),
	KEY(7, 1, KEY_I),
	KEY(7, 2, KEY_K),
	KEY(7, 3, KEY_M),
	KEY(7, 4, KEY_F6),

	KEY(8, 0, KEY_CAMERA_FOCUS),
	KEY(8, 1, KEY_O),
	KEY(8, 2, KEY_L),
	KEY(8, 3, KEY_QUESTION),
	KEY(8, 4, KEY_LEFT),
	...
	KEY(11, 0, KEY_VOLUMEUP),
	KEY(11, 1, KEY_VOLUMEDOWN),
};

static struct matrix_keymap_data vital2refresh_keymap_data = {
	.keymap_size = ARRAY_SIZE(vital2refresh_keymap),
	.keymap = vital2refresh_keymap,
};

static struct pm8xxx_keypad_platform_data vital2refresh_keypad_data = {
	.input_name = "vital2refresh_keypad",
	.input_phys_device = "vital2refresh_keypad/input0",
	...
	.row_hold_ns = 91500,
	.wakeup = 1,
	.keymap_data = &vital2refresh_keymap_data,
};
...
static struct pmic8058_led pmic8058_vital2refresh_leds[] = {
	[0] = {
...
static struct pmic8058_leds_platform_data pm8058_vital2refresh_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_vital2refresh_leds),
	.leds = pmic8058_vital2refresh_leds,
};
...
static uint32_t optical_device_gpio_config[] = {
	GPIO_CFG(PMIC_GPIO_PS_VOUT, 0, GPIO_CFG_INPUT,
...
/*		else {
		opt_vreg_L13 = vreg_get(NULL, "gp4");
	}
*/
...
#ifdef CONFIG_SENSORS_YAS_ACCEL_DRIVER
int acc_vreg_en(int on)
{
	static struct vreg *accel_vreg_main;
	static struct vreg *accel_vreg_io;

	if (accel_vreg_main == NULL) {
		if (system_rev >= 0)
			accel_vreg_main = vreg_get(NULL, "wlan");
...
static struct yas_platform_data acc_plat_data = {
	.vreg_en = acc_vreg_en,
};
#endif
...
#ifdef CONFIG_SENSORS_YAS_ACCEL_DRIVER
	{
	 I2C_BOARD_INFO("accelerometer", 0x12 >> 1),
...
static int __init buses_init(void)
{
	...
	pm8058_7x30_data.keypad_pdata = &vital2refresh_keypad_data;
...
static void fsa9485_jig_cb(bool attached)
{
	...
	set_cable_status = attached ? CABLE_TYPE_JIG : CABLE_TYPE_UNKNOWN;
	if (charger_callbacks && charger_callbacks->set_cable)
		charger_callbacks->set_cable(charger_callbacks,
					     set_cable_status);
...
static void fsa9485_dock_cb(int attached)
{
	...
	if (attached == FSA9485_ATTACHED_DESK_DOCK)
		...
		set_cable_status = CABLE_TYPE_UNKNOWN;
...
static int fsa9485_system_rev(void)
{
	return system_rev;
}
...
static int melfas_mux_fw_flash(bool to_gpios)
{
	...
	if (to_gpios) {
		...
		gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_IRQ, 0,
			GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 0);
...
int is_melfas_vdd_on(void)
{
	...
	if (ret) {
		printk(KERN_ERR "%s: vreg_touch enable"
		   ...
		   printk(KERN_INFO "%s: wlan2_vreg_touch"
			"enable success!\n", __func__);
	   }
}
...
static struct platform_device lcdc_db7420b_panel_device = {
...
{
	int ret = -EPERM;
	char panel[2][21] = { "lcdc_db7420b_hvga", "NONE" };
	int lcd_id = -1;
...
static int msm_fb_detect_panel(const char *name)
{
	...
	if (!strncmp(name, "lcdc_s6d05a1_hvga", 20))
		return 0;
#elif defined(CONFIG_FB_MSM_LCDC_DB7420B_HVGA_PANEL)
	if (!strncmp(name, "lcdc_DB7420B_hvga", 20))
		return 0;
...
static struct msm_gpio lcd_panel_gpios_sleep_cfg[] = {
	{GPIO_CFG(18, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn0"},
	{GPIO_CFG(19, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn1"},
	{GPIO_CFG(20, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu0"},
	...
	{GPIO_CFG(23, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red0"},
	{GPIO_CFG(24, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red1"},
	{GPIO_CFG(25, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red2"},
	{GPIO_CFG(90, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_pclk"},
	{GPIO_CFG(91, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_en"},
	{GPIO_CFG(92, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_vsync"},
	{GPIO_CFG(93, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_hsync"},
	{GPIO_CFG(94, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn2"},
	{GPIO_CFG(95, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn3"},
	{GPIO_CFG(96, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn4"},
	{GPIO_CFG(97, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn5"},
	{GPIO_CFG(98, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn6"},
	{GPIO_CFG(99, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_grn7"},
	{GPIO_CFG(100, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu3"},
	{GPIO_CFG(101, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu4"},
	{GPIO_CFG(102, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu5"},
	{GPIO_CFG(103, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu6"},
	{GPIO_CFG(104, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_blu7"},
	{GPIO_CFG(105, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red3"},
	{GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red4"},
	{GPIO_CFG(107, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red5"},
	{GPIO_CFG(108, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red6"},
	{GPIO_CFG(109, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcdc_red7"},
};

static int lcdc_db7420b_panel_power(int on)
{
	int rc, i;
	struct msm_gpio *gp;
...
static int lcdc_panel_power(int on)
{
	...
	return lcdc_db7420b_panel_power(on);
...
{
	pm8058_7x30_data.leds_pdata = &pm8058_vital2refresh_leds_data;
}
...
MACHINE_START(VITAL2REFRESH, "SPH-M935")
